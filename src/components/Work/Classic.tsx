...
import { arrowDownCircle, arrowLeftSquare } from "../../components/Utils/Svg.tsx";
    ...
    <main id="classic-section-wrapper">
      <section id="classic-section">
        ...
        <div id="classic-section-content" ref={sectionContent}>
          <div>
            <Image src={work.media1[0]} alt={work.media1[1]} />
          </div>
          <hr />
          <div>
            <Image src={work.media2[0]} alt={work.media2[1]} />
          </div>
          <hr />
          <div>
            <Image src={work.media3[0]} alt={work.media3[1]} />
          </div>
          <hr />
          <div>
            <Image src={work.media4[0]} alt={work.media4[1]} />
          </div>
          <hr />
        </div>
